      ...
      <div className="container" style={{color:props.mode==="dark"?"white":"black"}}>
        ...
        <div className="mb-3">
          <textarea
            ...
            style={{backgroundColor:props.mode==="dark"?"#0f4052":"white",color: props.mode==="dark"?"white":"black"}}
            value={text}
        ...
        <button disabled={text.length===0} className="btn btn-primary mx-1 my-1" onClick={handleReplaceClick}>
